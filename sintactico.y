...
%token PRINCIPAL NOMBRECAMPO ENTERO DECIMAL BOLEANO CADENA ITGR DOU T_F TEXT ASIGNADOR SUMA RESTA MULTIPLICACION DIVISION AUMENTAR DISMINUIR MAYOR MENOR IGUAL MAYORIGUAL MENORIGUAL DIFERENTE IF ELSE IFELSE FOR WHILE
...
principal		:	PRINCIPAL '(' ')' '{' lineascodigos '}';
